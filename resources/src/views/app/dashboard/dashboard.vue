      ...
      <b-col lg="3" md="6" sm="12">
        <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
          ...
          <div class="content">
            ...
            >{{formatNumber((report_today.sales?report_today.sales:0),2)}} {{currentUser.currency}}</p>
          </div>
        </b-card>
      </b-col>
      ...
      <b-col lg="3" md="6" sm="12">
        <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
          ...
          <div class="content">
            ...
            <p
              class="text-primary text-24 line-height-1 mb-2"
            >{{formatNumber((report_today.income?report_today.income:0),2)}} {{currentUser.currency}}</p>
          </div>
        </b-card>
      </b-col>
      ...
      <b-col lg="3" md="6" sm="12">
        <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
          ...
          <div class="content">
            ...
            <p
              class="text-primary text-24 line-height-1 mb-2"
            >{{formatNumber((report_today.expenses?report_today.expenses:0),2)}} {{currentUser.currency}}</p>
          </div>
        </b-card>
      </b-col>
      <b-col lg="3" md="6" sm="12">
        <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
          ...
          <div class="content">
            ...
            <p
              class="text-primary text-24 line-height-1 mb-2"
            >{{formatNumber((report_today.profit?report_today.profit:0),2)}} {{currentUser.currency}}</p>
          </div>
        </b-card>
      </b-col>
    </b-row>
