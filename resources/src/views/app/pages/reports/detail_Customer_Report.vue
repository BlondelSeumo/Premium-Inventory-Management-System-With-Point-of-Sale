      ...
      <b-col lg="3" md="6" sm="12">
        <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
          ...
          <div class="content">
            ...
            >{{formatNumber((client.total_amount),2)}} {{currentUser.currency}}</p>
          </div>
        </b-card>
      </b-col>
      <b-col lg="3" md="6" sm="12">
        <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
          ...
          <div class="content">
            ...
            <p
              class="text-primary text-24 line-height-1 mb-2"
            >{{formatNumber((client.total_paid),2)}} {{currentUser.currency}}</p>
          </div>
        </b-card>
      </b-col>
      <b-col lg="3" md="6" sm="12">
        <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
          ...
          <div class="content">
            ...
            <p
              class="text-primary text-24 line-height-1 mb-2"
            >{{formatNumber((client.due),2)}} {{currentUser.currency}}</p>
          </div>
        </b-card>
      </b-col>
    </b-row>
