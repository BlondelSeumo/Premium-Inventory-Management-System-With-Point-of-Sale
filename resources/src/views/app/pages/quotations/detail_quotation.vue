              ...
              <table class="table table-striped table-sm">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span>{{formatNumber(quote.TaxNet,2)}} {{currentUser.currency}} ({{formatNumber(quote.tax_rate ,2)}} %)</span>
                    </td>
                  </tr>
                  <tr>
                    <td class="bold">{{$t('Discount')}}</td>
                    <td>{{formatNumber(quote.discount,2)}} {{currentUser.currency}}</td>
                  </tr>
                  <tr>
                    <td class="bold">{{$t('Shipping')}}</td>
                    <td>{{formatNumber(quote.shipping,2)}} {{currentUser.currency}}</td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      ...
                      >{{formatNumber(quote.GrandTotal ,2)}} {{currentUser.currency}}</span>
                    </td>
                  </tr>
                </tbody>
              </table>
