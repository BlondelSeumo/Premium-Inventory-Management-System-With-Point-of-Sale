                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        >
                          ...
                          <td>{{formatNumber(detail.Net_cost, 3)}} {{currentUser.currency}}</td>
                  ...
                  <table class="table table-striped table-sm">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{formatNumber(purchase_return.discount ,2)}} {{currentUser.currency}}</td>
                      </tr>
                      <tr>
                        <td class="bold">{{$t('Shipping')}}</td>
                        <td>{{formatNumber(purchase_return.shipping ,2)}} {{currentUser.currency}}</td>
                      </tr>
                      <tr>
                        <td>
