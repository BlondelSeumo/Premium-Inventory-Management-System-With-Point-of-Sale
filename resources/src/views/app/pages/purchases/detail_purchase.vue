              ...
              <table class="table table-striped table-sm">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span>{{formatNumber(purchase.TaxNet,2)}} {{currentUser.currency}} ({{formatNumber(purchase.tax_rate,2)}} %)</span>
                    </td>
                  </tr>
                  <tr>
                    <td class="bold">{{$t('Discount')}}</td>
                    <td>{{formatNumber(purchase.discount ,2)}} {{currentUser.currency}}</td>
                  </tr>
                  <tr>
                    <td class="bold">{{$t('Shipping')}}</td>
                    <td>{{formatNumber(purchase.shipping,2)}} {{currentUser.currency}}</td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      ...
                      >{{formatNumber(purchase.GrandTotal,2)}} {{currentUser.currency}}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <span
                        class="font-weight-bold"
                      >{{formatNumber(purchase.paid_amount,2)}} {{currentUser.currency}}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <span
                        class="font-weight-bold"
                      >{{formatNumber(purchase.due,2)}} {{currentUser.currency}}</span>
                    </td>
                  </tr>
                </tbody>
              </table>
