...
export default {
    ...
    AddProductToList: "Si prega di aggiungere il prodotto all'elenco",
    AddQuantity: "Si prega di aggiungere la quantità",
    InvalidData: "Dati non validi",
    LowStock: "la cantidad excede la cantidad disponible en stock",
    WarehouseIdentical: "I due repository non possono essere identici",
    VariantDuplicate: "Questa variabile è ridondante",
    Paid: "Pagado",
    Unpaid: "No pagado",
    ...
    PleaseSelectStatut: "seleccione Statut",
    PayeBy: "Pagado con",
